...
# I will find the exact index of 'def trigger_pipeline(' and 'def _fallback_response('
start_idx = code.find('    def trigger_pipeline(self')
fallback_idx = code.find('    def _fallback_response(self')

if start_idx == -1 or fallback_idx == -1:
...
new_code = '''
    def trigger_pipeline(self, question: str, filters: Dict[str, Any] = None, history: List[Dict[str, Any]] = None, task_type: str = "QA") -> Dict[str, Any]:
        ...
        # Pass query_analysis if complex
...
print("Rewrote trigger_pipeline successfully using index replacement.")
