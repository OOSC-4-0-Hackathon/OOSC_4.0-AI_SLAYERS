...
const DESTINATION_LABELS = {
  '/civic': 'login.destCivic',
  '/know-your-kanoon': 'login.destKanoon',
  '/upload-chat': 'login.destUpload',
  '/dochub': 'login.destDocHub',
  '/reasoning': 'login.destReasoning',
  '/dashboard': 'login.destDashboard',
};
