...
export const CitationPill: React.FC<CitationPillProps> = ({
  ...
  const defaultExcerpt = excerpt || `Statutory provision under ${act} specifying enforceable rights, mandatory procedures, and limitation terms.`;
  ...
  return (
    ...
    >
      <button
        ...
        title="Click to view statutory source annotation"
      >
